...
![PageSpeed Report on Mobile](@assets/nuxt3-optimization/image.png)

PC 端：

![PageSpeed Report on PC](@assets/nuxt3-optimization/image-1.png)
...
|        |                       Before                       |                       After                        |
| :----- | :------------------------------------------------: | :------------------------------------------------: |
| PC 端  | ![优化前](@assets/nuxt3-optimization/image-9.png)  | ![优化后](@assets/nuxt3-optimization/image-10.png) |
| 移动端 | ![优化前](@assets/nuxt3-optimization/image-11.png) | ![优化后](@assets/nuxt3-optimization/image-12.png) |
